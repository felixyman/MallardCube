...
mod tests {
    ...
    fn malloy_is_cached_same_key() {
        ...
        let plan = QueryPlan::GroupBy {
            ...
            group_by: vec!["ProductCategory".to_string(), "Region".to_string()],
            filters: vec![],
        };
    ...
    fn equivalent_filters_share_cache() {
        ...
        let a = QueryPlan::Total {
            ...
            filters: vec![
                ...
                TypedDimensionFilter { dimension: "ProductCategory".to_string(), members: vec!["Category A".into()] , time_flag: None },
            ],
        };
