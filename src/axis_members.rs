...
// ---- ProductCategory member/property/hierarchy builders ----

pub(crate) fn product_category_dim_props_leaf(name: &str, requested: &[String]) -> Vec<(String, String)> {
...
pub(crate) fn product_category_dim_props_all(requested: &[String]) -> Vec<(String, String)> {
...
pub(crate) fn product_category_dim_decls() -> Vec<(String, String, String)> {
...
pub(crate) fn product_category_hierarchy(requested: &[String]) -> cellset::HierarchyConfig {
    cellset::HierarchyConfig {
...
pub(crate) fn product_category_leaf_member(name: &str, requested: &[String]) -> cellset::MemberConfig {
...
pub(crate) fn product_category_all_member(requested: &[String]) -> cellset::MemberConfig {
    cellset::MemberConfig {
        hierarchy: PRODUCTCATEGORY_HIER.into(),
...
pub(crate) fn product_category_leaf_members_from(names: &[String], requested: &[String]) -> Vec<cellset::MemberConfig> {
    names
        .iter()
...
pub(crate) const ALL_DIMS: &[&str] = &["Measures", "ProductCategory", "Region"];
