            ...
            config: ProxyConfig {
                ...
                dimensions: vec![
                    crate::proxy_config::DimensionConfig {
                        id: "ProductCategory".into(),
                        malloy_name: "product_category".into(),
                        physical_field: "product_category".into(),
                        caption: "ProductCategory".into(),
                        description: "Our product lines".into(),
                        hierarchy_name: "ProductCategory".into(),
                        all_level_name: "(All)".into(),
                        leaf_level_name: "ProductCategory".into(),
                        ordinal: 1,
                        visible: true,
                        has_all: true,
                        cardinality_hint: 50,
                ...
                measures: vec![
                    crate::proxy_config::MeasureConfig {
                        ...
                        numeric_scale: 2,
                        expression: "SUM('FactTable'[Sales])".into(),
...
mod tests {
    ...
    fn default_project_is_valid() {
        ...
        assert_eq!(p.model.primary_source_name(), "fact_table");
    ...
    fn config_derived_model_matches_default() {
        ...
        assert_eq!(
            built.dim_def("ProductCategory").caption,
            p.model.dim_def("ProductCategory").caption,
        );
    }
    ...
    fn second_project_loads() {
        ...
        assert_eq!(cat.semantic_name, "product_category");
        assert_eq!(cat.physical_field, "product_category");
    ...
    fn second_project_malloy_source() {
        ...
        assert!(src.contains("source: sales_data is duckdb.table('fact_table')"));
    ...
    fn second_project_group_by() {
        ...
        let src = p.malloy_source(&plan);
        assert!(src.contains("group_by: product_category, region"));
        assert!(src.contains("aggregate: revenue"));
    }
