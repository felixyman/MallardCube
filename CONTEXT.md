...
xmla_proxy/src/
  ...
  dimensions.rs        — MDSCHEMA_DIMENSIONS (2 dims: Measures TYPE=2, ProductCategory TYPE=0)
  hierarchies.rs       — MDSCHEMA_HIERARCHIES (2 hierarchies, both STRUCTURE=3)
  levels.rs            — MDSCHEMA_LEVELS (2 levels, both LEVEL_TYPE=0)
  measures.rs          — MDSCHEMA_MEASURES (1 measure: Total Sales)
  members.rs           — MDSCHEMA_MEMBERS (2 members: Total Forsaljning + All ProductCategoryer)
...
- Hierarchies: STRUCTURE=3 (was 1) for ProductCategory
