...
class Tag {
    ...
    scalarType(...at) {
        var _a;
        const val = at.length > 0 ? (_a = this.find(at)) === null || _a === void 0 ? void 0 : _a.getEq() : this.getEq();
        if (val === undefined || Array.isArray(val))
            return undefined;
        if (val instanceof Date)
            return 'date';
    ...
    *keys() {
    ...
    static quoteAndEscape(str, isProp = false) {
        if (str.match(/^[0-9A-Za-z_]+$/))
            return str;
        if (isProp)
            return `\`${Tag.escapeProp(str)}\``;
    ...
    toString() {
        ...
        function addChildren(tag) {
            var _a;
            const props = Object.keys((_a = tag.properties) !== null && _a !== void 0 ? _a : {});
        ...
        function addTag(child, isArrayEl = false) {
            ...
            if (child.properties) {
                ...
                if (!isArrayEl &&
                    props.length === 1 &&
                    !props.some(c => { var _a; return ((_a = child.properties) !== null && _a !== void 0 ? _a : {})[c].deleted; }) &&
                    child.eq === undefined) {
                    annotation += '.';
                    addChildren(child);
                }
                else {
                    if (!isArrayEl || child.eq !== undefined)
                        annotation += ' ';
                    annotation += '{ ';
                    addChildren(child);
                    annotation += ' }';
