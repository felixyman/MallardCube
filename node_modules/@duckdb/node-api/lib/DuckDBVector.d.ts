...
import { DuckDBArrayType, DuckDBBigIntType, DuckDBBigNumType, DuckDBBitType, DuckDBBlobType, DuckDBBooleanType, DuckDBDateType, DuckDBDecimalType, DuckDBDoubleType, DuckDBEnumType, DuckDBFloatType, DuckDBGeometryType, DuckDBHugeIntType, DuckDBIntegerType, DuckDBIntervalType, DuckDBListType, DuckDBMapType, DuckDBSmallIntType, DuckDBStructType, DuckDBTimeNSType, DuckDBTimeTZType, DuckDBTimeType, DuckDBTimestampMillisecondsType, DuckDBTimestampNanosecondsType, DuckDBTimestampSecondsType, DuckDBTimestampTZType, DuckDBTimestampType, DuckDBTinyIntType, DuckDBType, DuckDBUBigIntType, DuckDBUHugeIntType, DuckDBUIntegerType, DuckDBUSmallIntType, DuckDBUTinyIntType, DuckDBUUIDType, DuckDBUnionType, DuckDBVarCharType, DuckDBVariantType } from './DuckDBType';
import { DuckDBArrayValue, DuckDBBitValue, DuckDBBlobValue, DuckDBDateValue, DuckDBDecimalValue, DuckDBGeometryValue, DuckDBIntervalValue, DuckDBListValue, DuckDBMapValue, DuckDBStructValue, DuckDBTimeNSValue, DuckDBTimeTZValue, DuckDBTimeValue, DuckDBTimestampMillisecondsValue, DuckDBTimestampNanosecondsValue, DuckDBTimestampSecondsValue, DuckDBTimestampTZValue, DuckDBTimestampValue, DuckDBUUIDValue, DuckDBUnionValue, DuckDBValue, DuckDBVariantValue } from './values';
...
export declare class DuckDBBlobVector extends DuckDBVector<DuckDBBlobValue> {
     ...
     */
    getItemBytes(itemIndex: number): Uint8Array | null;
...
export declare class DuckDBGeometryVector extends DuckDBVector<DuckDBGeometryValue> {
    private readonly dataView;
    private readonly validity;
    private readonly vector;
    private readonly itemOffset;
    ...
    private readonly itemCacheDirty;
    constructor(dataView: DataView, validity: DuckDBValidity, vector: duckdb.Vector, itemOffset: number, itemCount: number);
    static fromRawVector(vector: duckdb.Vector, itemCount: number): DuckDBGeometryVector;
    get type(): DuckDBGeometryType;
    get itemCount(): number;
    getItem(itemIndex: number): DuckDBGeometryValue | null;
    setItem(itemIndex: number, value: DuckDBGeometryValue | null): void;
    flush(): void;
    slice(offset: number, length: number): DuckDBGeometryVector;
}
export declare class DuckDBVariantVector extends DuckDBVector<DuckDBVariantValue> {
    private readonly structVec;
    private readonly keysList;
    private readonly childrenList;
    private readonly valuesList;
    private readonly dataBlob;
    private readonly keysEntry;
    private readonly keysIdxVec;
    private readonly valuesIdxVec;
    private readonly typeIdVec;
    private readonly byteOffsetVec;
    constructor(structVec: DuckDBStructVector);
    static fromRawVector(vector: duckdb.Vector, itemCount: number): DuckDBVariantVector;
    get type(): DuckDBVariantType;
    get itemCount(): number;
    getItem(itemIndex: number): DuckDBVariantValue | null;
    setItem(_itemIndex: number, value: DuckDBVariantValue | null): void;
    flush(): void;
    slice(offset: number, length: number): DuckDBVariantVector;
    /**
