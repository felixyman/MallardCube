...
class DuckDBTimeNSType extends BaseDuckDBType {
    ...
    get max() {
        return values_1.DuckDBTimeNSValue.Max;
    }
    get min() {
        return values_1.DuckDBTimeNSValue.Min;
    }
}
exports.DuckDBTimeNSType = DuckDBTimeNSType;
exports.TIME_NS = DuckDBTimeNSType.instance;
class DuckDBGeometryType extends BaseDuckDBType {
    /**
...
class DuckDBVariantType extends BaseDuckDBType {
    constructor(alias) {
        super(DuckDBTypeId_1.DuckDBTypeId.VARIANT, alias);
    }
    static instance = new DuckDBVariantType();
    static create(alias) {
        return alias ? new DuckDBVariantType(alias) : DuckDBVariantType.instance;
    }
}
exports.DuckDBVariantType = DuckDBVariantType;
exports.VARIANT = DuckDBVariantType.instance;
