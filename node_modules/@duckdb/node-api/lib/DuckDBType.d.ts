...
import { DuckDBDateValue, DuckDBTimeNSValue, DuckDBTimestampMillisecondsValue, DuckDBTimestampNanosecondsValue, DuckDBTimestampSecondsValue, DuckDBTimestampTZValue, DuckDBTimestampValue, DuckDBTimeTZValue, DuckDBTimeValue, DuckDBUUIDValue } from './values';
...
export declare class DuckDBTimeNSType extends BaseDuckDBType<DuckDBTypeId.TIME_NS> {
    ...
    get max(): DuckDBTimeNSValue;
    get min(): DuckDBTimeNSValue;
}
export declare const TIME_NS: DuckDBTimeNSType;
export declare class DuckDBGeometryType extends BaseDuckDBType<DuckDBTypeId.GEOMETRY> {
    /**
