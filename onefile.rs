...
const DIM_ROWS: &str = r#"          <row>
          ...
          <row>
            ...
            <SCHEMA_NAME>Model</SCHEMA_NAME>
            <CUBE_NAME>Model</CUBE_NAME>
            <DIMENSION_NAME>ProductCategory</DIMENSION_NAME>
            <DIMENSION_UNIQUE_NAME>[ProductCategory]</DIMENSION_UNIQUE_NAME>
            <DIMENSION_CAPTION>ProductCategory</DIMENSION_CAPTION>
            <DIMENSION_ORDINAL>1</DIMENSION_ORDINAL>
            <DIMENSION_TYPE>0</DIMENSION_TYPE>
            <DIMENSION_CARDINALITY>50</DIMENSION_CARDINALITY>
            <DEFAULT_HIERARCHY>[ProductCategory]</DEFAULT_HIERARCHY>
            <DESCRIPTION>Our product lines</DESCRIPTION>
            <IS_VIRTUAL>false</IS_VIRTUAL>
            <IS_READWRITE>false</IS_READWRITE>
            <DIMENSION_UNIQUE_SETTINGS>0</DIMENSION_UNIQUE_SETTINGS>
            <DIMENSION_IS_VISIBLE>true</DIMENSION_IS_VISIBLE>
...
const HIER_ROWS: &str = r#"          <row>
          ...
          <row>
            ...
            <CUBE_NAME>Model</CUBE_NAME>
            <DIMENSION_UNIQUE_NAME>[ProductCategory]</DIMENSION_UNIQUE_NAME>
            <HIERARCHY_NAME>ProductCategory</HIERARCHY_NAME>
            <HIERARCHY_UNIQUE_NAME>[ProductCategory]</HIERARCHY_UNIQUE_NAME>
            <HIERARCHY_CAPTION>ProductCategory</HIERARCHY_CAPTION>
            <DIMENSION_TYPE>0</DIMENSION_TYPE>
            <HIERARCHY_CARDINALITY>50</HIERARCHY_CARDINALITY>
            <DEFAULT_MEMBER>[ProductCategory].[All ProductCategoryer]</DEFAULT_MEMBER>
            <ALL_MEMBER>[ProductCategory].[All ProductCategoryer]</ALL_MEMBER>
            <STRUCTURE>3</STRUCTURE>
            <DIMENSION_IS_VISIBLE>true</DIMENSION_IS_VISIBLE>
...
const LEVEL_ROWS: &str = r#"          <row>
          ...
          <row>
            ...
            <DIMENSION_UNIQUE_NAME>[ProductCategory]</DIMENSION_UNIQUE_NAME>
            <HIERARCHY_UNIQUE_NAME>[ProductCategory]</HIERARCHY_UNIQUE_NAME>
            <LEVEL_NAME>ProductCategory</LEVEL_NAME>
            <LEVEL_UNIQUE_NAME>[ProductCategory].[ProductCategory]</LEVEL_UNIQUE_NAME>
            <LEVEL_CAPTION>ProductCategory</LEVEL_CAPTION>
...
pub fn get_measure_groups_response() -> String {
    discover_rowset_envelope("", MEASUREGROUP_ROW_FIELDS,
        r#"          <row>
            <CATALOG_NAME>KTH_KEX_MALLOY_CUBE</CATALOG_NAME>
            <CUBE_NAME>Model</CUBE_NAME>
            <MEASUREGROUP_NAME>FactTable</MEASUREGROUP_NAME>
            <MEASUREGROUP_CAPTION>FactTable</MEASUREGROUP_CAPTION>
          </row>"#
    )
}
...
const MEASURE_ROWS: &str = r#"          <row>
            ...
            <MEASURE_UNIQUE_NAME>[Measures].[Total Sales]</MEASURE_UNIQUE_NAME>
            <MEASURE_CAPTION>Total Sales (SEK)</MEASURE_CAPTION>
            ...
            <MEASURE_UNQUALIFIED_CAPTION>Total Sales (SEK)</MEASURE_UNQUALIFIED_CAPTION>
            <MEASUREGROUP_NAME>FactTable</MEASUREGROUP_NAME>
...
const TABLE_ROWS: &str = r#"          <row>
            ...
            <TABLE_NAME>FactTable</TABLE_NAME>
          ...
          <row>
            <TABLE_CATALOG>KTH_KEX_MALLOY_CUBE</TABLE_CATALOG>
            <TABLE_SCHEMA>Model</TABLE_SCHEMA>
            <TABLE_NAME>ProductCategory</TABLE_NAME>
...
const DIM_ROWS: &str = r#"          <row>
          ...
          <row>
            ...
            <DIMENSION_CARDINALITY>50</DIMENSION_CARDINALITY>
            <DEFAULT_HIERARCHY>[ProductCategory].[ProductCategory]</DEFAULT_HIERARCHY>
            <DESCRIPTION>Our product lines</DESCRIPTION>
            <IS_VIRTUAL>false</IS_VIRTUAL>
            <IS_READWRITE>false</IS_READWRITE>
            <DIMENSION_UNIQUE_SETTINGS>0</DIMENSION_UNIQUE_SETTINGS>
            <DIMENSION_MASTER_UNIQUE_NAME>[ProductCategory]</DIMENSION_MASTER_UNIQUE_NAME>
            <DIMENSION_IS_VISIBLE>true</DIMENSION_IS_VISIBLE>
            <CUBE_SOURCE>1</CUBE_SOURCE>
          </row>"#;
...
const HIER_ROWS: &str = r#"          <row>
            ...
            <DIMENSION_TYPE>3</DIMENSION_TYPE>
            <HIERARCHY_CARDINALITY>50</HIERARCHY_CARDINALITY>
            <DEFAULT_MEMBER>[ProductCategory].[ProductCategory].[All]</DEFAULT_MEMBER>
            <ALL_MEMBER>[ProductCategory].[ProductCategory].[All]</ALL_MEMBER>
...
/// Intrinsic MEMBER properties (PROPERTY_TYPE=1) for the ProductCategory
...
fn member_property_rows() -> String {
    const HIER: &str = "[ProductCategory].[ProductCategory]";
    const DIM: &str = "[ProductCategory]";
    const LEVEL_ALL: &str = "[ProductCategory].[ProductCategory].[(All)]";
    const LEVEL_LEAF: &str = "[ProductCategory].[ProductCategory].[ProductCategory]";
...
/// MEMBER_VALUE-style rows (PROPERTY_TYPE=5). Two rows for the ProductCategory
...
const MEASURE_ROWS: &str = r#"          <row>
            ...
            <MEASURE_UNITS>SEK</MEASURE_UNITS>
            <DESCRIPTION>Total sales</DESCRIPTION>
            <EXPRESSION>SUM('FactTable'[Sales])</EXPRESSION>
            <MEASURE_IS_VISIBLE>true</MEASURE_IS_VISIBLE>
            <MEASURE_UNQUALIFIED_CAPTION>Total Sales (SEK)</MEASURE_UNQUALIFIED_CAPTION>
            <MEASUREGROUP_NAME>FactTable</MEASUREGROUP_NAME>
...
// -------- TMSCHEMA_TABLES: FactTable + ProductCategory --------
...
// -------- TMSCHEMA_RELATIONSHIPS: 1 row (FactTable.ProductKey → ProductCategory.ProductKey) --------
pub fn get_tmschema_relationships_response() -> String {
    ...
    let rows = r#"          <row>
            <ID>10</ID>
            <ModelID>1</ModelID>
            <Name>FactTable_ProductCategory</Name>
